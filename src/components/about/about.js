...
import IMAGE_NETCORE from "../../assets/dotnetcore.svg";
import IMAGE_POSTGRE from "../../assets/postgre.png";
...
const About = (props) => {
  ...
  const DATA_HEXAGONS = [
    ...
    },
    {
      header: "human touch",
      subheader:
        "I like my apps leaving a lasting impression with the first interaction.",
    },
  ];
      ...
      <div className="hexa-container flerow">
        {DATA_HEXAGONS.map((hexagon) => {
          return (
            <Hexagon
              key={hexagon.header}
              hexa_header={hexagon.header}
              hexa_subheader={hexagon.subheader}
            >
        ...
        <div className="about__info_tech">
          <div className="tech flerow obs-anim-appear">
            ...
            <img
              ...
              alt=".NET Core 3.0"
            />
            <img title="PostgreSQL" src={IMAGE_POSTGRE} alt="PostgreSQL" />
