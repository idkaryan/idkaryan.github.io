    ...
    return(
        <React.Fragment>
            ...
            <ProjectItem 
                ...
                projectThumb="https://i.imgur.com/RrYKiTD.gif"
                projectValues={{
                        title:"Cave Story clone", 
                        desc:"This project was done in 2016 while I was in college. Used C++ with a graphics library called SDL2 which provided API for taking keyboard input and drawing images on screen, using which I created this cavestory level. Used artwork from the original game.", 
                        piclink:"https://i.imgur.com/RrYKiTD.gif", 
                        techstack:["C++", "SDL2"]
                }}
            />
            ...
            <ProjectItem 
                ...
                projectValues={{
                    ...
                    desc:"This project was done in 2017 while I was in college. Learned using a scripting language(GDScript) as well as an open source game engine(Godot).", 
